...
var OrgSubRegion = (function (_Page) {
  _inherits(OrgSubRegion, _Page);

  function OrgSubRegion() {
    _classCallCheck(this, _OrgSubRegion);

    _get(Object.getPrototypeOf(_OrgSubRegion.prototype), 'constructor', this).apply(this, arguments);
  }

  var _OrgSubRegion = OrgSubRegion;
  OrgSubRegion = (0, _componentsLayoutPageTransitionLayout.page)(OrgSubRegion) || OrgSubRegion;
  return OrgSubRegion;
})(_componentsLayoutPageTransitionLayout2['default']);

exports['default'] = OrgSubRegion;
