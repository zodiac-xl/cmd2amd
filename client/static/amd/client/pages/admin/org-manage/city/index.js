...
var OrgCity = (function (_Page) {
  _inherits(OrgCity, _Page);

  function OrgCity() {
    _classCallCheck(this, _OrgCity);

    _get(Object.getPrototypeOf(_OrgCity.prototype), 'constructor', this).apply(this, arguments);
  }

  var _OrgCity = OrgCity;
  OrgCity = (0, _componentsLayoutPageTransitionLayout.page)(OrgCity) || OrgCity;
  return OrgCity;
})(_componentsLayoutPageTransitionLayout2['default']);

exports['default'] = OrgCity;
