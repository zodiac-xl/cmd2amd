...
var OrgRegion = (function (_Page) {
  _inherits(OrgRegion, _Page);

  function OrgRegion() {
    _classCallCheck(this, _OrgRegion);

    _get(Object.getPrototypeOf(_OrgRegion.prototype), 'constructor', this).apply(this, arguments);
  }

  var _OrgRegion = OrgRegion;
  OrgRegion = (0, _componentsLayoutPageTransitionLayout.page)(OrgRegion) || OrgRegion;
  return OrgRegion;
})(_componentsLayoutPageTransitionLayout2['default']);

exports['default'] = OrgRegion;
