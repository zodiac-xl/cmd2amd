...
var SeatReport = (function (_Page) {
  _inherits(SeatReport, _Page);

  function SeatReport() {
    _classCallCheck(this, _SeatReport);

    _get(Object.getPrototypeOf(_SeatReport.prototype), 'constructor', this).apply(this, arguments);
  }

  var _SeatReport = SeatReport;
  SeatReport = (0, _componentsLayoutPageTransitionLayout.page)(SeatReport) || SeatReport;
  return SeatReport;
})(_componentsLayoutPageTransitionLayout2['default']);

exports['default'] = SeatReport;
