...
define(["/amd/client/components/business/apply/apply.js","/amd/client/components/business/record-form/record-form.js","/amd/client/components/layout/page-transition-layout.js"], function (ref_2,ref_3,ref_4) {

    var cmd2amdModules = {"react":{"external":"React","index":null,"path":null},"react-dom":{"external":"ReactDOM","index":null,"path":null},"../../../../components/business/apply/apply":{"index":0,"path":"client/components/business/apply/apply.js"},"../../../../components/business/record-form/record-form":{"index":1,"path":"client/components/business/record-form/record-form.js"},"../../../../components/layout/page-transition-layout":{"index":2,"path":"client/components/layout/page-transition-layout.js"}};
...
$(function () {
    ...
    $body.delegate(".J_create_cinema_activity", "click", function () {
        ...
        var component = _reactDom2['default'].render(_react2['default'].createElement(_componentsBusinessApplyApply2['default'], null), applyContainer);
    });
    ...
    $body.delegate(".J_record-apply", "click", function () {
        ...
        var props = {
            ...
            cinemaId: apply.cinemaId,
            cinemaName: apply.cinemaName,
            checkApply: function checkApply(record) {}
        };
    ...
    $body.delegate('.J_checkAndEdit', 'click', function () {
        var apply = $(applyContainer).data('apply');
        var props = {
            applyId: apply.applyId,
            versionType: apply.versionType,
            applyType: apply.applyType,
