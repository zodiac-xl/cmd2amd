...
var ReactCheckedEqualPathLink = (function (_ReactPathLink) {
    _inherits(ReactCheckedEqualPathLink, _ReactPathLink);

    function ReactCheckedEqualPathLink(component, key, equalValue) {
        _classCallCheck(this, ReactCheckedEqualPathLink);

        _get(Object.getPrototypeOf(ReactCheckedEqualPathLink.prototype), 'constructor', this).call(this, component, key);
        this._equalValue = equalValue;
        this.getComponentValue();
    }

    _createClass(ReactCheckedEqualPathLink, [{
    ...
    return ReactCheckedEqualPathLink;
})(_reactPathLink2['default']);

exports['default'] = ReactCheckedEqualPathLink;
