...
var ReactCheckedPathLink = (function (_ReactPathLink) {
    _inherits(ReactCheckedPathLink, _ReactPathLink);

    function ReactCheckedPathLink(component, key) {
        _classCallCheck(this, ReactCheckedPathLink);

        _get(Object.getPrototypeOf(ReactCheckedPathLink.prototype), 'constructor', this).call(this, component, key);
        this._has = has;
        this.getComponentValue();
    }

    _createClass(ReactCheckedPathLink, [{
