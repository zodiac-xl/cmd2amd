...
var CompetitivePrice = (function (_Page) {
  _inherits(CompetitivePrice, _Page);

  function CompetitivePrice() {
    _classCallCheck(this, _CompetitivePrice);

    _get(Object.getPrototypeOf(_CompetitivePrice.prototype), 'constructor', this).apply(this, arguments);
  }

  var _CompetitivePrice = CompetitivePrice;
  CompetitivePrice = (0, _componentsLayoutPageTransitionLayout.page)(CompetitivePrice) || CompetitivePrice;
  return CompetitivePrice;
})(_componentsLayoutPageTransitionLayout2['default']);

exports['default'] = CompetitivePrice;
