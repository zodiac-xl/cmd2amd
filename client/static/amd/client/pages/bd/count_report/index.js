...
var CountReport = (function (_Page) {
  _inherits(CountReport, _Page);

  function CountReport() {
    _classCallCheck(this, _CountReport);

    _get(Object.getPrototypeOf(_CountReport.prototype), 'constructor', this).apply(this, arguments);
  }

  var _CountReport = CountReport;
  CountReport = (0, _componentsLayoutPageTransitionLayout.page)(CountReport) || CountReport;
  return CountReport;
})(_componentsLayoutPageTransitionLayout2['default']);

exports['default'] = CountReport;
