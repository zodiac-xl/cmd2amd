...
var Cost = (function (_SuperChild) {
    _inherits(Cost, _SuperChild);

    function Cost() {
        _classCallCheck(this, Cost);

        _get(Object.getPrototypeOf(Cost.prototype), 'constructor', this).apply(this, arguments);
    }
            ...
            if (readOnly) {
                ...
                rightDom = React.createElement(
                    ...
                    React.createElement(
                        ...
                        '限制  ',
                        React.createElement('input', _extends({}, _commonValidatemap2['default'].number, { min: '1', value: valueLink.value || '', placeholder: '数字，包括服务费',
