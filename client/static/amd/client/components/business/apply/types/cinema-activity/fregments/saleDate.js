...
var SaleDate = (function (_SuperChild) {
    _inherits(SaleDate, _SuperChild);

    function SaleDate() {
        _classCallCheck(this, SaleDate);

        _get(Object.getPrototypeOf(SaleDate.prototype), 'constructor', this).apply(this, arguments);
    }

    _createClass(SaleDate, [{
        key: 'defaultValue',
