...
var TotalLimit = (function (_SuperChild) {
    _inherits(TotalLimit, _SuperChild);

    function TotalLimit() {
        _classCallCheck(this, TotalLimit);

        _get(Object.getPrototypeOf(TotalLimit.prototype), 'constructor', this).apply(this, arguments);
    }

    _createClass(TotalLimit, [{
        key: 'defaultValue',
        value: function defaultValue() {
            return ''; //总量限制* number  不限为0
        }
    }, {
        key: 'getStateByProps',
            ...
            if (readOnly) {
                ...
                rightDom = React.createElement(
                    ...
                    React.createElement(
                        ...
                        { name: 'totalLimit', value: radioValue,
