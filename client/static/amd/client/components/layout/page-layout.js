...
define(["/amd/node_modules/lodash/index.js","/amd/client/components/include/header.js","/amd/client/components/include/footer.js","/amd/client/components/include/side-bar.js","/amd/client/components/debug/index.js","/amd/client/components/layout/page.js"], function (ref_2,ref_3,ref_4,ref_5,ref_6,ref_7) {

    var cmd2amdModules = {"react":{"external":"React","index":null,"path":null},"react-dom":{"external":"ReactDOM","index":null,"path":null},"lodash":{"index":0,"path":"node_modules/lodash/index.js"},"../include/header":{"index":1,"path":"client/components/include/header.js"},"../include/footer":{"index":2,"path":"client/components/include/footer.js"},"../include/side-bar":{"index":3,"path":"client/components/include/side-bar.js"},"../debug":{"index":4,"path":"client/components/debug/index.js"},"./page":{"index":5,"path":"client/components/layout/page.js"}};
...
var PageLayout = (function (_BasePage) {
    _inherits(PageLayout, _BasePage);

    function PageLayout() {
        _classCallCheck(this, PageLayout);

        _get(Object.getPrototypeOf(PageLayout.prototype), 'constructor', this).apply(this, arguments);
    }
    ...
    _createClass(PageLayout, [{
        ...
        value: function renderDebug() {
            ...
            var debugDom;
            debugDom = _react2['default'].createElement(
                'div',
                null,
        ...
        value: function page(Page) {
            $(function () {
                ...
                _reactDom2['default'].render(_react2['default'].createElement(Page, null), container);
            });
        }
    }]);
