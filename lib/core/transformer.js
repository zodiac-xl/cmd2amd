define(['module', 'exports', 'path', 'del', 'fileutil', 'concat-regexp', 'easy-file', 'gulp', 'webpack-stream', 'gulp-less', 'gulp-rename', 'gulp-wrapper', 'gulp-intercept', 'gulp-watch', 'path-exists', './util', "babel-core"], function (module, exports, _path, _del, _fileutil, _concatRegexp, _easyFile, _gulp, _webpackStream, _gulpLess, _gulpRename, _gulpWrapper, _gulpIntercept, _gulpWatch, _pathExists, _util, babel) {
    'use strict';
